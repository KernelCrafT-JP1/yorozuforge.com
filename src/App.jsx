...
export function App() {
  ...
  const nav = <><a href="./services.html" onClick={() => setMenuOpen(false)}>相談・開発</a><a href="./workshop.html" onClick={() => setMenuOpen(false)}>工房について</a><a href="./representative.html" onClick={() => setMenuOpen(false)}>代表</a><a href={boothUrl} target="_blank" rel="noreferrer" onClick={() => setMenuOpen(false)}>BOOTH<span className="sr-only">（新しいタブで開きます）</span></a><button className="nav-contact" onClick={contact}>お問い合わせ</button></>;
