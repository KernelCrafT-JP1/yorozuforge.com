...
export function App() {
  const page = location.pathname.endsWith('/services.html') ? 'services' : location.pathname.endsWith('/workshop.html') ? 'workshop' : 'home';
...
{page !== 'home' && <div className="breadcrumbs"><a href="./">トップ</a><span aria-hidden="true"> / </span><span>{page === 'services' ? '相談・開発' : '工房について'}</span></div>}
